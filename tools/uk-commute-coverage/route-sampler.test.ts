...
describe('Route Sampler', () => {
  describe('haversineDistance', () => {
    test('calculates distance between London and Manchester correctly', () => {
      ...
      const manchester: [number, number] = [-2.2426, 53.4808];
    ...
    test('returns same distance regardless of direction', () => {
      ...
      const point2: [number, number] = [-2.2426, 53.4808];
  ...
  describe('sampleRoute', () => {
    ...
    test('throws error for invalid input', () => {
      ...
      assert.throws(() => sampleRoute(null as unknown as [number, number][], 500), /at least 2 points/);
    });
  ...
  describe('getTotalDistance', () => {
    ...
    test('returns 0 for single point', () => {
      const route: [number, number][] = [[-0.1276, 51.5074]];
      const total = getTotalDistance(route);
  ...
  describe('sampleRouteByCount', () => {
    ...
    test('throws error for invalid input', () => {
      ...
      assert.throws(() => sampleRouteByCount(null as unknown as [number, number][], 500), /at least 2 points/);
    });
